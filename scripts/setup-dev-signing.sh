#!/bin/zsh
#
# Create a local self-signed code signing identity for Dev Island dev
...
IDENTITY_NAME="Dev Island Dev Local"
...
echo "you give Dev Island Dev will persist across rebuilds."
