...
base_dir="${DEV_ISLAND_HARNESS_ARTIFACT_DIR:-$repo_root/output/harness/smoke-all-$timestamp}"
...
for scenario in "${scenarios[@]}"; do
    ...
    DEV_ISLAND_HARNESS_SCENARIO="$scenario" \
    DEV_ISLAND_HARNESS_ARTIFACT_DIR="$scenario_dir" \
