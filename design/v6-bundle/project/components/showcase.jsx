  ...
  return (
    <div className="app">
      ...
      <header className="topbar">
        <div className="brand">
          <span className="dot" />
          <span>Dev Island — Brand Redesign</span>
        </div>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ padding: 16, lineHeight: 1.55 }}>
            <div style={{ color: '#6ee7b7' }}>~/dev-island git:(main) $ <span style={{ color: '#fff' }}>claude code "refactor NotchPresenter"</span></div>
