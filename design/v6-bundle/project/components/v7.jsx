...
// ---------- Data ----------
const SESSIONS = [
  { id: 's1', agent: 'claude', state: 'waiting', project: 'dev-island', branch: 'refactor/claude-kernel-pid-monitor', msg: '开始执行吧，先补测试再提 PR', you: '<task-notification>', terminal: 'Ghostty', age: '2h', detail: { tool: 'Edit', target: 'Sources/DevIslandCore/Sessions/SessionState.swift L124-156' } },
  { id: 's2', agent: 'claude', state: 'waiting', project: 'dev-island', branch: 'fix/external-island-width', msg: '有用户反馈外接屏宽度计算有问题', you: '提个 PR', terminal: 'Ghostty', age: '4h', detail: { tool: 'Bash', target: 'git diff --stat' } },
  { id: 's3', agent: 'codex',  state: 'running', project: 'dev-island', branch: 'main', msg: '分析 session reducer 的测试覆盖率', you: 'run tests', terminal: 'Terminal', age: '3m', detail: { tool: 'Bash', target: 'swift test --filter SessionStateTests' } },
  { id: 's4', agent: 'claude', state: 'idle', project: 'dev-island', branch: 'main', msg: '', you: '', terminal: 'Ghostty', age: '<1m' },
  { id: 's5', agent: 'claude', state: 'idle', project: 'dev-island', branch: 'main', msg: '', you: '', terminal: 'Ghostty', age: '<1m' },
  { id: 's6', agent: 'codex',  state: 'idle', project: 'dev-island', branch: 'main', msg: '', you: '', terminal: 'cmux', age: '<1m' },
  ...
  { id: 's8', agent: 'codex',  state: 'idle', project: 'dev-island', branch: 'main', msg: '', you: '', terminal: 'WezTerm', age: '<1m' },
];
...
function ContentNotif({ kind, macbook, onClose }) {
  const bodyMap = {
    ...
    three: {
      ...
      code: 'Sources/DevIslandCore/Sessions/SessionState.swift\n+ 23 lines  − 8 lines  · L124–L156',
      sub: 'dev-island · fix/external-island-width',
    ...
    jump: {
      ...
      code: '3 files changed, 47 insertions(+), 12 deletions(−)\n  M  Sources/DevIslandCore/Sessions/SessionState.swift\n  M  Tests/DevIslandCoreTests/SessionStateTests.swift\n  A  docs/hooks.md',
  ...
  return (
    <div className="app v3">
      <header className="topbar">
        <div className="brand"><span className="dot-v3"/><span>Dev Island · v7 — pill as panel</span></div>
