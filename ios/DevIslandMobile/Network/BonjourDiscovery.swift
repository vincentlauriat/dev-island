...
/// Discovered Mac running Dev Island.
...
/// Uses NWBrowser to discover macOS instances advertising `_devisland._tcp`.
@MainActor
final class BonjourDiscovery: ObservableObject {
    private static let logger = Logger(subsystem: "app.devisland.mobile", category: "BonjourDiscovery")
