...
public enum ManagedHooksBinary {
    public static let binaryName = "DevIslandHooks"
...
public enum HooksBinaryLocator {
    public static func locate(
        ...
        if let explicitPath = environment["DEV_ISLAND_HOOKS_BINARY"] ?? environment["VIBE_ISLAND_HOOKS_BINARY"],
        ...
        let candidates = [
            executableDirectory?.appendingPathComponent("DevIslandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("DevIslandHooks"),
            executableDirectory?.deletingLastPathComponent().appendingPathComponent("Helpers/DevIslandHooks"),
            ...
            #endif
            return [
                currentDirectory.appendingPathComponent(".build/\(archTriple)/release/DevIslandHooks"),
                currentDirectory.appendingPathComponent(".build/release/DevIslandHooks"),
                ...
                currentDirectory.appendingPathComponent(".build/\(archTriple)/debug/DevIslandHooks"),
                currentDirectory.appendingPathComponent(".build/debug/DevIslandHooks"),
