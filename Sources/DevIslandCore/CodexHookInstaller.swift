...
public struct CodexHookInstallerManifest: Equatable, Codable, Sendable {
    public static let fileName = "dev-island-install.json"
...
public enum CodexHookInstaller {
    ...
    public static let managedStatusMessage = "Managed by Dev Island"
    ...
    private static func isManagedHookForInstall(_ hook: [String: Any], replacingCommand: String) -> Bool {
        ...
        return isLegacyDevIslandHookCommand(command)
    }
    ...
    private static func isLegacyDevIslandHookCommand(_ command: String) -> Bool {
        ...
        return normalized.contains("dev-island-bridge") || normalized.contains("vibe-island-bridge")
    }
