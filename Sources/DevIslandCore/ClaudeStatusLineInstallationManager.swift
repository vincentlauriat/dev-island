...
public final class ClaudeStatusLineInstallationManager: @unchecked Sendable {
    public static let managedScriptName = "dev-island-statusline"
    public static let wrappedDelegateScriptName = "dev-island-statusline-delegate"
    ...
    public static func wrappedDelegateScript(originalCommand: String) -> String {
        "#!/bin/bash\n# Original Claude Code statusLine.command preserved by Dev Island.\n\(originalCommand)\n"
    }
    ...
    public static func managedScript(cacheURL: URL = managedCacheURL) -> String {
        ...
        # It feeds usage data (5h/7d quotas) to the Dev Island
