...
public final class WatchNotificationRelay: @unchecked Sendable {
    private static let logger = Logger(subsystem: "app.devisland", category: "WatchNotificationRelay")
    ...
    private let queue = DispatchQueue(label: "app.devisland.watch.relay")
