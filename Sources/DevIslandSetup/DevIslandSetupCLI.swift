...
private struct SetupCommand {
    ...
    private func install() throws {
        ...
        print("Installed Dev Island Codex hooks.")
    ...
    private func uninstall() throws {
        ...
        print("Removed Dev Island Codex hooks.")
        print("Codex dir: \(status.codexDirectory.path)")
    ...
    private func installClaude() throws {
        ...
        print("Installed Dev Island Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        print("Hooks binary: \(hooksBinary.path)")
        if status.hasClaudeIslandHooks {
            print("Note: claude-island hooks are still present alongside Dev Island hooks.")
        }
    }
    ...
    private func uninstallClaude() throws {
        ...
        print("Removed Dev Island Claude hooks.")
        print("Claude dir: \(status.claudeDirectory.path)")
        if status.hasClaudeIslandHooks {
    ...
    private func installKimi() throws {
        ...
        print("Installed Dev Island Kimi hooks.")
    ...
    private func uninstallKimi() throws {
        ...
        print("Removed Dev Island Kimi hooks.")
        print("Kimi dir: \(status.kimiDirectory.path)")
...
private enum SetupError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .usage:
            """
            Usage:
              swift run DevIslandSetup install [--hooks-binary /abs/path/to/DevIslandHooks] [--codex-dir /abs/path/to/.codex]
              swift run DevIslandSetup uninstall [--codex-dir /abs/path/to/.codex]
              swift run DevIslandSetup status [--hooks-binary /abs/path/to/DevIslandHooks] [--codex-dir /abs/path/to/.codex]
              swift run DevIslandSetup installClaude [--hooks-binary /abs/path/to/DevIslandHooks] [--claude-dir /abs/path/to/.claude]
              swift run DevIslandSetup uninstallClaude [--claude-dir /abs/path/to/.claude]
              swift run DevIslandSetup statusClaude [--hooks-binary /abs/path/to/DevIslandHooks] [--claude-dir /abs/path/to/.claude]
              swift run DevIslandSetup installKimi [--hooks-binary /abs/path/to/DevIslandHooks] [--kimi-dir /abs/path/to/.kimi]
              swift run DevIslandSetup uninstallKimi [--kimi-dir /abs/path/to/.kimi]
              swift run DevIslandSetup statusKimi [--hooks-binary /abs/path/to/DevIslandHooks] [--kimi-dir /abs/path/to/.kimi]
            """
