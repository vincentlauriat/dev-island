    ...
    static func runningSession(now: Date) -> AgentSession {
        AgentSession(
            ...
            codexMetadata: CodexSessionMetadata(
                ...
                currentCommandPreview: "sed -n '1,260p' Sources/DevIslandApp/Views/SettingsView.swift"
            )
        )
    }
    ...
    static func approvalSession(now: Date) -> AgentSession {
        AgentSession(
            ...
            permissionRequest: PermissionRequest(
                ...
                summary: "Allow exec_command to rewrite SettingsView.swift?",
                affectedPath: "Sources/DevIslandApp/Views/SettingsView.swift",
...
[README.md](/Users/wangruobing/Personal/dev-island/README.md) 的现有改动已经单独提交了，commit 是 `f196316`，message 是 `docs: update readme tagline`。
