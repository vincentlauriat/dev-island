...
### Delete entirely
- `Sources/DevIslandApp/TerminalSessionAttachmentProbe.swift` (1170 lines)

### New file
- `Sources/DevIslandApp/TerminalJumpTargetResolver.swift` (~250 lines) — AppleScript snapshot matching for jump target precision only

### Simplify or delete
- `Sources/DevIslandCore/ClaudeSessionRegistry.swift` (159 lines) — delete or gut to ~30 lines for pending-interaction-only persistence

### Modify: `Sources/DevIslandCore/AgentSession.swift`
...
### Modify: `Sources/DevIslandCore/SessionState.swift`
...
### Modify: `Sources/DevIslandApp/AppModel.swift` (~450 lines removed)
...
### Modify: `Sources/DevIslandCore/BridgeServer.swift`
