...
Dev Island is community-driven. The best product experiences are created by deep users of each tool. We welcome contributions of all kinds — pick an area below and start vibing.

Think of Dev Island as having done the basics: a macOS island shell + code agent communication layer + fundamental features like notifications and terminal jump-back. Everything else can be defined by you.
...
| 2 | **IDE / Plugin Jump-back** | Support jumping back to IDE or in-IDE terminal windows, or apps with integrated code agent plugins (Cursor, VSCode, GoLand, Obsidian, etc.). | Planned | [#173](https://github.com/vincentlauriat/dev-island/issues/173), [#183](https://github.com/vincentlauriat/dev-island/issues/183) |
