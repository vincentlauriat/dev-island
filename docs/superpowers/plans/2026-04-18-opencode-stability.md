...
**Files:**
- Create: `Sources/DevIslandCore/OpenCodeSessionRegistry.swift`
...
```bash
git add Sources/DevIslandCore/OpenCodeSessionRegistry.swift
...
**Files:**
- Modify: `Sources/DevIslandApp/SessionDiscoveryCoordinator.swift`
...
```bash
git add Sources/DevIslandApp/SessionDiscoveryCoordinator.swift
...
**Files:**
- Modify: `Sources/DevIslandApp/AppModel.swift`
- Modify: `Sources/DevIslandApp/ProcessMonitoringCoordinator.swift`
...
```bash
git add Sources/DevIslandApp/AppModel.swift Sources/DevIslandApp/ProcessMonitoringCoordinator.swift
...
2. Check `~/Library/Application Support/dev-island/opencode-session-registry.json`.
3. Restart Dev Island.
